...
export default {
  ...
  data() {
    ...
    {
      "code": "en",
      "flag_1x1": "flags/1x1/en.svg",
      "flag_4x3": "flags/4x3/en.svg",
    ...
    <ul>
      <li v-for="movie in state.movies">
        ...
        <div class="language-box">
          ...
          <img v-if="movie.original_language.length == 2" style="width: 30px;" :src="`flags/4x3/${movie.original_language}.svg`" alt="">
